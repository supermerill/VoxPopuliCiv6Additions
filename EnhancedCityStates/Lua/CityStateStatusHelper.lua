...
-- Global Constants
------------------------------------------------------
local kModMoreCities = GameDefines.CITY_STATE_SCALE_PER_CITY_MOD / 100
local kModMedieval = GameDefines.FRIENDSHIP_THRESHOLD_MOD_MEDIEVAL / 100
local kModIndustrial = GameDefines.FRIENDSHIP_THRESHOLD_MOD_INDUSTRIAL / 100
local kEraMedieval = GameInfoTypes.ERA_MEDIEVAL
local kEraIndustrial = GameInfoTypes.ERA_INDUSTRIAL
