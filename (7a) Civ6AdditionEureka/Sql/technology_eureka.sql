...
--ancient
UPDATE Technologies SET EurekaPerMillion = 100000, MaxEurekaCount = 3 WHERE Type = 'TECH_TRAPPING';
UPDATE Technologies SET EurekaPerMillion = 100000, MaxEurekaCount = 3 WHERE Type = 'TECH_POTTERY';
UPDATE Technologies SET EurekaPerMillion = 100000, MaxEurekaCount = 3 WHERE Type = 'TECH_THE_WHEEL';
UPDATE Technologies SET EurekaPerMillion = 100000, MaxEurekaCount = 3 WHERE Type = 'TECH_ANIMAL_HUSBANDRY';
UPDATE Technologies SET EurekaPerMillion = 100000, MaxEurekaCount = 3 WHERE Type = 'TECH_MINING';
...
UPDATE Technologies SET EurekaPerMillion = 30000, MaxEurekaCount = 10 WHERE Type = 'TECH_MASONRY';
...
VALUES ('[ICON_BULLET]Eureka: {5_color}{1_NbEurekas} ({2_PercentEurekas}%){6_endcolor} / {3_NbMaxEurekas} ({4_PercentMaxEurekas}%)'
,'TXT_KEY_EUREKA_TOOLTIP');

INSERT INTO Language_en_US (Text, Tag)
VALUES ('{1_techname} : now {2_nbEureka}/{3_maxEureka} Eurekas'
,'TXT_KEY_EUREKA_NOTIFICATION');
INSERT INTO Language_en_US (Text, Tag)
VALUES ('Eureka Update'
,'TXT_KEY_EUREKA_NOTIFICATION_TITLE');

INSERT INTO Language_en_US (Text, Tag)
VALUES ('Eureka: -10% cost for each scout trained (max 3).'
,'TXT_KEY_TECH_TRAPPING_HELP_EUREKA');
INSERT INTO Language_en_US (Text, Tag)
VALUES ('Eureka: -10% cost per policy unlocked (max 3)'
,'TXT_KEY_TECH_POTTERY_HELP_EUREKA');
INSERT INTO Language_en_US (Text, Tag)
VALUES ('Eureka: -10% cost per monument or shrine (max 3)'
,'TXT_KEY_TECH_THE_WHEEL_HELP_EUREKA');
INSERT INTO Language_en_US (Text, Tag)
VALUES ('Eureka: -10% cost for each worker trained (max 3)'
,'TXT_KEY_TECH_ANIMAL_HUSBANDRY_HELP_EUREKA');
INSERT INTO Language_en_US (Text, Tag)
VALUES ('Eureka: -10% cost for each warrior trained (max 3)'
...
INSERT INTO Language_en_US (Text, Tag)
VALUES ('Eureka: -3% cost per building (max 10)'
